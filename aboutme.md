...
I teach history at the University of Arkansas at Little Rock (in a region whose own Creole history has often been treated as "marginal"), where I work with students to connect local histories to global processes and to bring our findings to audiences beyond the classroom. As it turns out, doing history "from the margins"—both social and geographical—not only makes for richer scholarship; it can help us rethink the ways the past figures in the stories we tell about our communities.
